...
INSERT INTO artifacts(name, atype, weight, allocation_info, power_info, flags, effects, bonus, message, description) VALUES
   ('Amulet of Carlammas', '0:-1', 3, '10:1:100', '', 'RES_FIRE', '', '3:CON@1:STR', '', 'A fiery circle of bronze, with mighty spells:ward off and banish evil'),
   ('Amulet of Ingwe', '0:-1', 3, '30:1:127', '', 'RES_ACID|RES_COLD|RES_ELEC|RES_CONF','', '3:INT|WIS', '', 'The ancient heirloom of Ingwë, high lord of the Vanyar, against whom nothing of evil could stand.'),
   ('Amulet of Elessar', '0:-1', 3, '52:2:3', '0:0d0:0:0:10', 'RES_FEAR|RES_FIRE|RES_POIS|INSTA_ART', '', '2:STR|WIS|SPEED', 'You feel a warm tingling inside...', 'A green stone, imbued with the power of Elvendom and the light of the Sun. Those who gaze through it see the aged and infirm as young again, and its wearer brings healing after victory in battle.'),
   ...
   ('Ring of Tulkas', '1:-1', 2, '32:1:127', '', 'RES_FEAR', '', '4:STR|DEX|CON', '', 'The treasure of Tulkas, most fleet and wrathful of the Valar.'),
   ('Ring of Narya', '1:-1', 2, '82:2:127', '0:0d0:2:2:0', 'REGEN|TELEPATHY|SUST_STR|SUST_CONIM_FIRE|RES_FIRE|RES_FEAR', '', '1:STR|INT|WIS|DEX|CON@5:SPEED', '', 'The Ring of Fire, made of gold and set with a ruby that glows like flame. Narya is one of the three Rings of Power created by Celebrimbor and hidden by the Elves from Sauron.'),
   ('Ring of Nenya', '1:-1', 2, '22:3:127', '0:0d0:3:3:0', 'HOLD_LIFE|REGEN|IM_COLD|RES_COLD|RES_BLIND', '', '2:STR|INT|WIS|DEX|CON@5:SPEED', '', 'The Ring of Adamant, made of mithril with a pure white stone as centerpiece.  Nenya is one of the three Rings of Power created by Celebrimbor and hidden by the Elves from Sauron.'),
   ('Ring of Vilya', '1:-1', 2, '51:2:127', '0:0d0:5:5:0', 'HOLD_LIFE|REGEN|IM_ELEC|RES_ELEC|RES_POIS|RES_DARK', '','3:STR|INT|WIS|DEX|CON@5:SPEED', '', 'The Ring of Sapphire, made of gold with a brilliant blue gem that shines like stars.  It glitters untouchable despite all that Morgoth ever wrought. Vilya is one of the three Rings of Power created by Celebrimbor and hidden by the Elves from Sauron.'),
   ...
   ('Mithril plate mail of Celeborn', '2:-1', 250, '60:4:127', '65:2d4:-3:0:25', 'RES_ACID|RES_ELEC|RES_FIRE|RES_COLD|RES_DARK|RES_DISEN', '', '3:STR', '', 'A shimmering suit of true-silver, forged long ago by dwarven smiths of legend. It gleams with purest white as you gaze upon it, and mighty are its powers:protect and banish.'),
   ('Leather armour of Himring', '2:-1', 100, '20:2:90', '20:0d0:0:0:15', 'RES_CHAOS|RES_POIS', '', '', '', 'In this studded cuirass of pliable leather lives the memory of unvanquished Himring, defiant fortress surrounded by the legions of Morgoth.'),
   ...
   ('Shield of Gil-galad', '3:-1', 80, '25:2:127', '20:1d3:0:0:20', 'RES_ELEC|RES_ACID', '', '5:WIS@1:LIGHT', 'Your shield with the light of a thousand stars...', 'The legendary shield of Ereinion Gil-galad, who fought his way:the gates of the Dark Tower, and with whom came light even:Gorgoroth.'),
   ...
   ('Crown of Gondor', '4:-1', 30, '5:3:127', '0:1d1:0:0:15','RES_COLD|RES_FIRE|RES_LIGHT|RES_BLIND|RES_CONFU|REGEN', '', '3:STR|CON@2:WIS@1:LIGHT', 'You feel a warm tingling inside...', 'From dying Númenor, Elendil brought this shining winged circlet, emblem of Gondor through an age of the world.'),
   ...
   ('Gloves of Eol', '5:-1', 25, '3:1:127', '3:1d1:0:0:14', 'RES_ELEC|RES_DARK|RES_POIS|IM_FIRE', '', '3:INT', '', 'The iron-shod gauntlets of the Dark Elven smith Eöl, who imbued them with magics he could channel in battle.'),
   ('Gloves of Cambeleg', '5:-1', 5, '3:2:100', '1:0d0:8:8:15', '', '', '2:STR|CON', '', 'A hero\'s handgear that lends great prowess in battle.'),
   ('Gloves of Paurnimmen', '5:-1', 25, '5:3:127', '3:1d1:0:0:14', 'RES_COLD', '', '', 'Your gloves covered in frost...', 'A set of handgear, freezing with unnatural cold.'),
   ('Boots of Dal-i-thalion', '6:-1', 20, '4:2:100', '2:1d1:0:0:15', 'RES_CONFU', '', '5:DEX|SPEED', '', 'A pair of high-laced shoes, bestowing of extraordinary agility and proof against the powers of corruption and withering.'),
   ...
   ('Anduril', '7:0', 130, '3:2:127', '0:3d5:10:15:10', 'RES_FEAR|SLAY_EVIL|SLAY_TROLL|SLAY_ORC|SLAY_UNDEAD|RES_FIRE|RES_DISEN', '', '4:STR|DEX', 'Anduril rages in fire...', 'The famed "Flame of the West", the Sword that was Broken and is forged again.  It glows with the essence of fire, its wearer is mighty in combat, and no creature of Sauron can withstand it.'),
   ('Axe of Theoden', '7:1', 180, '7:2:100', '0:2d6:8:10:0', 'REGEN', '', '3:WIS|CON', '', 'The narrow axe head of this weapon would pierce the armour of a very Dragon, and the designs of your enemies stand naked and revealed.'),
